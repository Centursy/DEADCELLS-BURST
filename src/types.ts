...
export interface BattleResult {
  ...
  droppedEquipment?: { type: 'weapon' | 'offhand' | 'item' | 'amulet'; id: string; traits?: string[]; weaponQuality?: WeaponQuality; weaponTrait?: string | null }
}
...
export interface DeathmatchResult {
  ...
  winnerName?: string
  events: BattleEvent[]
  participants: Array<{ userId: string; username: string; hp: number; maxHp: number; eliminated: boolean }>
}
