...
function bossConfig(difficulty, random) {
    if (difficulty === 'veteran')
        return { maxHp: randomInt(random, 23000, 31000), attackMultiplier: 1.5, rewardMultiplier: 2 };
    if (difficulty === 'veteran-king')
        return { maxHp: randomInt(random, 35000, 50000), attackMultiplier: 2, rewardMultiplier: 3 };
