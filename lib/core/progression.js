...
function getPlayerStats(player) {
    ...
    const traitStats = (0, amulets_1.parseAmuletTraits)(player.amuletTraits).map(amulets_1.getAmuletTrait).filter(Boolean).reduce((total, current) => ({
...
function getAmuletCellMultiplier(player) {
    return (0, amulets_1.parseAmuletTraits)(player.amuletTraits)
